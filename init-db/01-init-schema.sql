...
--
-- IMPORTANT: Si vous voulez réinitialiser la base, vous devez :
-- 1. Arrêter les containers: docker compose down
-- 2. Supprimer le volume: docker volume rm mypacer_infra_db_data (prod)
--                     ou docker volume rm mypacer_infra_db_staging_data (staging)
-- 3. Redémarrer: docker compose up -d
-- ============================================================================

\echo '========================================'
\echo 'Initializing MyPacer Database Schema'
\echo '========================================'
...
\echo '========================================'
\echo 'MyPacer Database Schema Created Successfully!'
\echo '========================================'
